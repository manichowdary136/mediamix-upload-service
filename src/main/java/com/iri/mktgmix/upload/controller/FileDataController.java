...
public class FileDataController {
    ...
    @PostMapping(value = "/{fileUploadId}", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    public List<Map<String, Object>> getFileData(
            @PathVariable Long fileUploadId,
            @RequestBody FileDataRequest request) {
        return uploadedFileDataService.getFileData(fileUploadId, request);
    }
